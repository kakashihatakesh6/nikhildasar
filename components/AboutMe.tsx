                    ...
                    <Tabs defaultValue="1" className="max-w-[500px] ">
                        ...
                        <TabsContent value="2">
                            <div className='border-slate-700 border bg-slate-800 bg-opacity-65 w-[80%] m-4 p-2' >
                                ...
                                <div className='text-slate-300 px-4 py-2 ' >  <ul><li> Bachelor of Technology | 2019-2023</li></ul> </div>
                                <div className='text-slate-300 px-4 py-2 ' > Government Engineering College, Bilaspur  </div>
                                <div className='text-slate-300 px-4 py-2 ' > {`Information Technology - (8.03 CGPA)`}</div>
                            </div>
                        </TabsContent>
                        <TabsContent value="3">
